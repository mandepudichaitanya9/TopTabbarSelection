...
class ViewController: UIViewController {
    ...
    func addInventoryListView() {
        ...
        self.inventoryList.roomsBtn.addTarget(self, action: #selector(videoButtonAction), for:.touchUpInside)
        self.inventoryList.category.addTarget(self, action: #selector(photosButtonAction), for: .touchUpInside)
